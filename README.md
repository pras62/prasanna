  ...
  <head>
   ...
   <body>
    <h1>communication concepts and strategies </h1>
     ...
     <img src="j.png" alt="evidence" style="width:700px;height:400px">
     <p> I contacted my unit co-ordinator via email when I had some confusion regarding my class</p>
     <img src="p.jpg" alt="evidence" style="width:200px;height:400px">
     <p>This is a screenshot of a video call that I did with my parents when I wanted to talk with them</p>
